...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::resolve_dat_descriptor_path,
            commands::copy_item_dats_to_project,
            commands::reset_item_editor_data_to_retail_base,
            commands::are_all_item_dats_made_in_project,
            commands::copy_zone_entity_dat_to_project,
            commands::reset_zone_entity_dat_to_retail_base,
            commands::is_zone_entity_dat_made_in_project,
            commands::load_zone_editor_data,
            commands::save_zone_editor_data,
