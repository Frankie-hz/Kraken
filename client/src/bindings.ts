...
async resolveDatDescriptorPath(descriptor: DatDescriptor, lang: DatLanguage | null) : Promise<Result<string, any>> {
    try {
...
async copyItemDatsToProject(lang: DatLanguage | null) : Promise<Result<string[], any>> {
    try {
